...
import ImgItem from '../../atoms/imageitem/ImgItem';
import Input from '../../atoms/input/Input';
import ComIcon from '../../atoms/icon/ComIcon';
import IconWithDropDown from '../../molecules/iconwithdropdown/IconWithDropDown';
import { ICONS } from '../../../data/Icon';
import { Dropdown } from '../../atoms/dropdown/Dropdown';
import { dummyOption } from '../../../data/DropdownData';
import './header.css'
                        ...
                        <li className="nav-item nav-profile dropdown">
                            <a className="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="nav-profile-text">
                                    <p className="mb-1 text-black">Shakith Dev</p>
                                </div>
                            </a>
